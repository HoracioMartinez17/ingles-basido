# 📚 Metodología para Crear Trucos Educativos - English Waiter
...
4. **Evitan la sobrecarga cognitiva** - Una sola idea central, no múltiples excepciones
...
Me lo pasé bien: "I had a good time." (Ai jad a gud táim)
```
...
## Categorías de Trucos

La app organiza trucos en 4 categorías según su contexto:

1. **⏱️ Tiempos Verbales (grammar)**
   - Pasado, presente, futuro
   - Ejemplos: "I had", "It's like", "Instead"

2. **🎤 Servicio al Cliente (service)**
   - Cómo hablar en la sala
   - Ejemplos: "Please", "Like" para describir

3. **🏨 Hotel y Recepción (hotel)**
   - Habitaciones, incidencias, huéspedes
   - Ejemplos: "Check-in", "Available"

4. **📋 Expresiones Generales (general)**
   - Frases cortas de uso amplio
   - Ejemplos: "Same", "Again"
...
EJEMPLOS:
1. ES: Bebí una cerveza
   EN: I had a beer.
   PRON: Ai jad a bí-er

2. ES: Comí una hamburguesa
   EN: I had a burger.
   PRON: Ai jad a bér-guer

3. ES: Me lo pasé bien
   EN: I had a good time.
   PRON: Ai jad a gud táim

TIPS: Perfecto para hablar de experiencias en pasado.
```
...
EXPLICACIÓN:
Para describir un plato o bebida que el cliente no conoce,
usa "Like" que significa "como" para hacer comparaciones.
Vincula con algo que sí conocen.

EJEMPLOS:
1. ES: Es como un Gin Tonic
   EN: It's like a Gin and Tonic.
   PRON: Its láik a Yin and Tó-nic

2. ES: Es parecido a una pizza
   EN: It's like a pizza.
   PRON: Its láik a píts-a

TIPS: Usa "like" para conectar con experiencias previas del cliente.
```
...
## Plantilla para Crear Trucos Nuevos

Copia esta estructura y complétala:

```
TÍTULO: [Emoji] El truco del "[PALABRA]" (Traducción directa)

CATEGORÍA: [grammar | service | hotel | general]

EXPLICACIÓN: (1-2 oraciones explicando el patrón)


EJEMPLOS:
1. ES: [Situación real de camarero en español]
   EN: [Frase exacta en inglés]
   PRON: [Pronunciación fonética]
...
TIPS: [Contexto de cuándo usar, o diferencia vs. otra palabra]
```
...
**Truco Efectivo = Idea Simple + Ejemplos Reales + Pronunciación Clara + Contexto Aplicable**

No necesita ser perfecto, necesita ser **memorable, útil y verdadero**.

¡Ahora ya tienes la estructura! Crea tantos trucos como quieras. 🚀
